...
const N8N_WEBHOOK = "/api/mazda-chat"

type Msg = { from: "user" | "bot"; text: string }

export default function MazdaChatTiny() {
  const [open, setOpen] = useState(false)
  const [msgs, setMsgs] = useState<Msg[]>([
    {
      from: "bot",
      text: "Hi there! I'm your Mazda Maintenance Assistant. How can I help you with your maintenance notifications today?",
    },
  ])
  ...
  return (
    <>
      ...
      {open ? (
        <div style={box} role="region" aria-label="Mazda Maintenance Assistant chat">
          <div style={headWrap}>
            <span>Mazda Maintenance Assistant</span>
          ...
          <div style={hint}>I'll help you with Mazda maintenance notifications via your n8n flow.</div>
        ...
        >
          ...
          <span style={{ fontWeight: 600 }}>Chat with Mazda Assistant</span>
        </button>
      )}
    </>
  )
